...
<body>
    ...
    <div id="showcase" class="promo-area">
        <div class="front-slider flexslider">
            <ul class="slides">
                ...
                <li>
                    <img src="images/mainpromo/welcome02-400.jpg"
                         alt=""
                ...
                <li>
                    <img
                         ...
                         srcset="images/mainpromo/welcome04-400.jpg 400w,
                                 ...
                                 images/mainpromo/welcome04-1600.jpg 1600w"
                         sizes="(max-width: 400px) 400px, (max-width: 800px) 800px, 100vw"
                    >
                </li>
            </ul>
            ...
            <div class="three-reasons centered">
                <figure class="reason">
                    <a href="#">
                        <img
                             ...
                             alt="Learn more about A Room with a View"
                             srcset="images/mainpromo/welcome02-400.jpg 400w,
                                     images/mainpromo/welcome02-800.jpg 800w"
                ...
                <figure class="reason">
                    <a href="#">
                        <img
                            ...
                            alt="Learn more about Luxurious Sleep"
                            srcset="images/mainpromo/welcome03-400.jpg 400w,
                                    images/mainpromo/welcome03-800.jpg 800w"
                            sizes="(max-width: 400px) 400px, 100vw"
                        >
                ...
                <figure class="reason">
                    <a href="#">
                        <img
                            src="images/mainpromo/welcome04-400.jpg"
                            alt="Learn more about First Class Treatment"
                            srcset="images/mainpromo/welcome04-400.jpg 400w,
                                    images/mainpromo/welcome04-800.jpg 800w"
                            sizes="(max-width: 400px) 400px, 100vw"
                        >
            ...
            <figure class="feature">
                <a href="#">
                    <img
                        ...
                        alt="Learn more about Apartment Class Accommodations"
            ...
            <figure class="feature">
                <a href="#">
                    <img
                        ...
                        alt="Learn more about Five-Star Dining"
            ...
            <figure class="feature">
                <a href="#">
                    <img
                        ...
                        alt="Learn more about Gravity Gym"
            ...
            <figure class="feature">
                <a href="#">
                    <img
                        ...
                        alt="Learn more about Moon Dust Spa"
                ...
                <ul class="slides">
                    <li>
                        <figure class="story-wrapper">
                            <img
                                src="images/testimonials/bluepebble-400.jpg"
                                alt=""
                                srcset="images/testimonials/bluepebble-400.jpg 400w,
                                        images/testimonials/bluepebble-800.jpg 800w"
                                sizes="(max-width: 400px) 400px, 100vw"
                            >
                    ...
                    <li>
                        <figure class="story-wrapper">
                            <img
                                src="images/testimonials/earth-400.jpg"
                                alt=""
                                srcset="images/testimonials/earth-400.jpg 400w,
                                        images/testimonials/earth-800.jpg 800w"
                                sizes="(max-width: 400px) 400px, 100vw"
                            >
                            <figcaption class="story">
                    ...
                    <li>
                        <figure class="story-wrapper">
                            <img
                                src="images/testimonials/footprint-400.jpg"
                                alt=""
                                srcset="images/testimonials/footprint-400.jpg 400w,
                                        images/testimonials/footprint-800.jpg 800w"
                                sizes="(max-width: 400px) 400px, 100vw"
                            >
                            <figcaption class="story">
                    ...
                    <li>
                        <figure class="story-wrapper">
                            <img
                                src="images/testimonials/zerog-400.jpg"
                                alt=""
                                srcset="images/testimonials/zerog-400.jpg 400w,
                                        images/testimonials/zerog-800.jpg 800w"
                                sizes="(max-width: 400px) 400px, 100vw"
                            >
                            <figcaption class="story">
    ...
    <script src="JS/flexslider.js" async></script>
    <script src="JS/menu-toggle.js" async></script>
